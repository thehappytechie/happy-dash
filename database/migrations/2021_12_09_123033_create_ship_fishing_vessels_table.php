...
class CreateShipFishingVesselsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ship_fishing_vessels', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ship_fishing_vessels');
    }
}
