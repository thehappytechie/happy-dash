...
class CreateLicenseCoastalCraftsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('license_coastal_crafts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('license_coastal_crafts');
    }
}
