...
class CreateTranscriptRegistersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transcript_registers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('transcript_registers');
    }
}
