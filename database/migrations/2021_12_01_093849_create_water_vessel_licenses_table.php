...
class CreateWaterVesselLicensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('water_vessel_licenses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('water_vessel_licenses');
    }
}
