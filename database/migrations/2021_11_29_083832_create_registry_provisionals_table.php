...
class CreateRegistryProvisionalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registry_provisionals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('registry_provisionals');
    }
}
