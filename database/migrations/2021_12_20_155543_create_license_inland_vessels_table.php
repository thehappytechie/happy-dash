...
class CreateLicenseInlandVesselsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('license_inland_vessels', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('license_inland_vessels');
    }
}
