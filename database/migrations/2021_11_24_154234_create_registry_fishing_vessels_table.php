...
class CreateRegistryFishingVesselsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('registry_fishing_vessels', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('registry_fishing_vessels');
    }
}
