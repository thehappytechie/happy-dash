...
<x-layout>
    ...
    <h1 class="text-lg">Add Fishing Vessels Ships Marking & Marking Note</h1>
    </div>
            ...
            <form action="{{ route('change-name.store') }}" method="POST" class="margin-x-lg">
                ...
                <div class="margin-y-md">
                    <div class="grid gap-lg margin-right-lg">
                        ...
                        <div class="col-6@md">
                            <label class="form-label margin-bottom-xxs" for="registry tonnage">Register Tonnage</label>
                        ...
                        <div class="col-6@md">
                            <label class="form-label margin-bottom-xxs" for="gross tonnage">Date</label>
                            <input class="form-control width-100%  @error('gross_tonnage') is-error @enderror" type="date"
                        ...
                        <div class="col-6@md">
                            <label class="form-label margin-bottom-xxs" for="steam motor">Port of</label>
                        ...
                        <div class="col-6@md">
                            <label class="form-label margin-bottom-xxs" for="vessel location">Dated at</label>
                            <input class="form-control width-100%  @error('vessel_location') is-error @enderror" type="date"
                        ...
                        <div class="col-6@md">
                            <label class="form-label margin-bottom-xxs" for="proposed ship name">Location</label>
