...
<x-layout>
    <div class="margin-bottom-md">
        <h1 class="text-lg">Add Transcript of Register </h1>
    </div>
            ...
            <form action="{{ route('registry.store') }}" method="POST" class="margin-x-lg">
                ...
                <div class="margin-y-md">
                    <div class="grid gap-lg margin-right-lg">
                        <a href="{{ route('transcriptRegister') }}">Go to Forms</a>
                    ...
                    <div class="grid gap-lg margin-right-lg">
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('stern') is-error @enderror" type="text"
                                name="stern" value="{{ old('stern') }}" id="stern">
                            @error('stern')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                    ...
                    <x-submit-button>Create Form </x-submit-button>
                </div>
            </form>
        </div>
    </div>
