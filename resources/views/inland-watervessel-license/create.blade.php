...
<x-layout>
    <div class="margin-bottom-md">
        <h1 class="text-lg">Add License for Inland Water cVessels</h1>
    </div>
            ...
            <form action="{{ route('registry.store') }}" method="POST" class="margin-x-lg">
                ...
                <div class="margin-y-md">
                    <div class="grid gap-lg margin-right-lg">
                        <a href="{{ route('registry.store') }}">Go to licenses</a>
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('prev_port_registry') is-error @enderror"
                                type="text" name="prev_port_registry" value="{{ old('prev_port_registry') }} " id="prev_port_registry">
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('steam_motor') is-error @enderror" type="text"
                                name="steam_motor" value="{{ old('steam_motor') }}" id="steam_motor">
                            @error('steam_motor')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        ...
                        <div class="col-4@md ">
                            ...
                            <input class="form-control width-100%  @error('when_built') is-error @enderror" type="text"
                                name="when_built" value="{{ old('when_built') }}" id="when_built">
                            @error('when_built')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        <div class="col-4@md ">
                            ...
                            <input class="form-control width-100%  @error('name_address_builders') is-error @enderror"
                                type="text" name="name_address_builders" value="{{ old('name_address_builders') }}"id="name_address_builders">
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('stem') is-error @enderror" type="text"
                                name="stem" value="{{ old('stem') }}" id="stem">
                            @error('stem')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('build') is-error @enderror" type="text"
                                name="build" value="{{ old('build') }}" id="build">
                            @error('build')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('bulkheads') is-error @enderror" type="text"
                                name="bulkheads" value="{{ old('bulkheads') }}" id="bulkheads">
                            @error('bulkheads')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('overall_length') is-error @enderror"
                                type="text" name="overall_length" value="{{ old('overall_length') }}" id="overall_length">
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('breadth_mould') is-error @enderror"
                                type="text" name="breadth_mould" value="{{ old('breadth_mould') }}" id="breadth_mould">
                            @error('breadth_mould')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('depth_mould') is-error @enderror" type="text"
                                name="depth_mould" id="depth_mould" value="{{ old('depth_mould') }}">
                            @error('depth_mould')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                    ...
                    <div class="grid gap-lg margin-right-lg">
                        ...
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('no_engines') is-error @enderror" type="text"
                                name="no_engines" value="{{ old('no_engines') }}" id="no_engines">
                            @error('no_engines')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        <div class="col-4@md">
                            ...
                            <input class="form-control width-100%  @error('no_shafts') is-error @enderror" type="text"
                                name="no_shafts" value="{{ old('no_shafts') }}" id="no_shafts">
                            @error('no_shafts')
                            <x-validation-error>{{ $message }}</x-validation-error>
                            @enderror
                        </div>
                        ...
                        <div class="col-4@md">
                            <label class="form-label margin-bottom-xxs" for="engine name address maker">Name and address
                                of makers(engine)</label>
                            <input class="form-control width-100%  @error('engine_name_address_maker') is-error @enderror"
                                type="text" name="engine_name_address_maker" id="engine_name_address_maker" value="{{ old('engine_name_address_maker') }}">
                    ...
                    <div class="grid gap-lg margin-right-lg">
                        ...
                        <div class="col-4@md">
                            <label class="form-label margin-bottom-xxs" for="number passengers">Number of passengers</label>
                            <input class="form-control width-100%  @error('number_passengers') is-error @enderror"
                                type="text" name="number_passengers" id="number_passengers" value="{{ old('number_passengers') }}">
