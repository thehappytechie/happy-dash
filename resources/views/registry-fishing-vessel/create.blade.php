...
<x-layout>
    <div class="margin-bottom-md">
        <h1 class="text-lg">Add Certificate of Registry (Fishing Vessel)</h1>
    </div>
    <div class="grid gap-sm">
        <div class="bg radius-md padding-md shadow-xs col-12">
            <form action="{{ route('registry-fishing-vessel.store') }}" method="POST" class="margin-x-lg">
                @csrf
                <div class="margin-y-md">
                    <div class="grid gap-lg margin-right-lg">
                        <a href="{{ route('certificateRegistryFishingVessel') }}">Go to certificates</a>
