...
<x-layout>
    ...
    <h1 class="text-lg">Add Ship Marking & Marking Note</h1>
    </div>
    <div class="grid gap-sm">
        <div class="bg radius-md padding-md shadow-xs col-12">
            <form action="{{ route('ship-marking-carving.store') }}" method="POST" class="margin-x-lg">
                @csrf
                <div class="margin-y-md">
                    <div class="grid gap-lg margin-right-lg">
                        <a href="{{ route('shipMarkingCarving') }}">Go to forms</a>
